...
<div class="container-md">
  <div class="row border border-dark m-5" style="min-height: 30rem">
    <div class="container">
      <div class="row" style="padding-top: 3rem;min-height: 30rem">
        ...
        <div class="col-8" style="position:relative">
          <h3>{{ $event->name}}</h3>
          <p class="text-muted">{{ strtok($event->description, '.') }}</p>
          <p class=""> {{ substr($event->description, strpos($event->description, '.')+2) }}</p>
          <div class="d-flex flex-row justify-content-between align-items-end" style="position:absolute;bottom: 0">
            ...
            <button type="button" class="btn btn-link" style="text-decoration: none;">
              ...
              <span>{{ count($event->comments) }} Comment</p>
            </button>
            <button type="button" class="btn btn-link pb-4" style="text-decoration: none;">
        ...
        <div class="col-3 pe-3 me-0">
          <img src="../images/community-events.jpeg" class="img-fluid m-0 p-0" height="300" width="400" alt="...">
        </div>
      </div>
    </div>
  </div>
  <div class="row border border-dark" data-id="1" style="margin: 3rem; margin-left: 10rem">
    <div class="container">
      <div class="row align-items-center">
        ...
        <div class="col-8">
          <h4>daniresi</h4>
          <p class="text-muted">Joined 2 years ago</p>
          <p>Great work on your side.</p>
