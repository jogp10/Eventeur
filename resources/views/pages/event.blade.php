...
<div id="{{$event->id}}" class="event container-md d-flex flex-column" style="width:100%">
  <div class="d-flex flex-column border border-dark m-3 p-2 ps-4 pe-4 rounded" style="min-height: 500px">
    ...
    <div class="d-flex flex-row mt-auto justify-content-between align-items-end pb-3 ps-4 pe-4">
      ...
      <button type="button" class="btn btn-link align-self-center" style="text-decoration: none; color: black;">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-clock" viewBox="0 0 16 16">
          <path d="M8 3.5a.5.5 0 0 0-1 0V9a.5.5 0 0 0 .252.434l3.5 2a.5.5 0 0 0 .496-.868L8 8.71V3.5z" />
          <path d="M8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16zm7-8A7 7 0 1 1 1 8a7 7 0 0 1 14 0z" />
        </svg>
        <span class="">{{ $event->start_date }}</span>
      </button>
      ...
      <a href=" {{ route( 'deleteEvent', $event->id ) }} " type="button" class="btn btn-link btn-outline-danger" style="text-decoration: none;">
      ...
      <button type="button" class="btn btn-primary" style="text-decoration: none; color: black;">
