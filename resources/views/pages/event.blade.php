...
<div class="container-md d-flex flex-column" style="width:100%">
  <div class="event border border-dark m-3 d-flex flex-row justify-content-between" style="min-height: 600px">
    <div class="p-2 ps-4">
    ...
    <div class="p-2 pb-1 d-flex flex-column">
      ...
      <div class="d-flex flex-row mt-auto justify-content-between pb-3">
