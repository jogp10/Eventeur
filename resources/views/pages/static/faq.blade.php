        ...
        <div>
            <div class="container text-center pb-4">
                <div class="row border border-dark">
                    <h2 class="col-sm-11">1. What is Eventeur?</h2>
                    <svg xmlns="http://www.w3.org/2000/svg" class="col-sm-1" width="16" height="16" fill="currentColor" class="bi bi-chevron-down" viewBox="0 0 16 16" style="display:block" onclick="toggleDescription('1', this)">
                        <path fill-rule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z" />
                    </svg>
                    <svg xmlns="http://www.w3.org/2000/svg" class="col-sm-1" width="16" height="16" fill="currentColor" class="bi bi-chevron-up" viewBox="0 0 16 16" style="display:none" onclick="toggleDescription('1', this)">
                        <path fill-rule="evenodd" d="M7.646 4.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1-.708.708L8 5.707l-5.646 5.647a.5.5 0 0 1-.708-.708l6-6z" />
                    </svg>
                </div>
                <div class="row border border-secondary pt-2" style="display: none;">
            ...
            <div class="container text-center pb-4">
                <div class="row border border-dark">
                    <h2 class="col-sm-11">2. The event was canceled, and now?</h2>
                    <svg xmlns="http://www.w3.org/2000/svg" class="col-sm-1" width="16" height="16" fill="currentColor" class="bi bi-chevron-down" viewBox="0 0 16 16" style="display:block" onclick="toggleDescription('2', this)">
                        <path fill-rule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z" />
                    </svg>
                    <svg xmlns="http://www.w3.org/2000/svg" class="col-sm-1" width="16" height="16" fill="currentColor" class="bi bi-chevron-up" viewBox="0 0 16 16" style="display:none" onclick="toggleDescription('2', this)">
                        <path fill-rule="evenodd" d="M7.646 4.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1-.708.708L8 5.707l-5.646 5.647a.5.5 0 0 1-.708-.708l6-6z" />
                    </svg>
                </div>
                <div class="row border border-secondary pt-2" style="display: none;">
            ...
            <div class="container text-center pb-4">
                <div class="row border border-dark">
                    <h2 class="col-sm-11">3. I want to report an event, what should I do?</h2>
                    <svg xmlns="http://www.w3.org/2000/svg" class="col-sm-1" width="16" height="16" fill="currentColor" class="bi bi-chevron-down" viewBox="0 0 16 16" style="display:block" onclick="toggleDescription('3', this)">
                        <path fill-rule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z" />
                    </svg>
                    <svg xmlns="http://www.w3.org/2000/svg" class="col-sm-1" width="16" height="16" fill="currentColor" class="bi bi-chevron-up" viewBox="0 0 16 16" style="display:none" onclick="toggleDescription('3', this)">
                        <path fill-rule="evenodd" d="M7.646 4.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1-.708.708L8 5.707l-5.646 5.647a.5.5 0 0 1-.708-.708l6-6z" />
                    </svg>
                </div>
                <div class="row border border-secondary pt-2" style="display: none;">
            ...
            <div class="container text-center pb-4">
                <div class="row border border-dark">
                    <h2 class="col-sm-11">4. Can anyone create an event</h2>
            ...
            <div class="container text-center pb-4">
                <div class="row border border-dark">
                    <h2 class="col-sm-11">5. I bought the wrong ticker, can I refund it?</h2>
            ...
            <div class="container text-center pb-4">
                <div class="row border border-dark">
                    <h2 class="col-sm-11">6. I got banned! What do I do now?</h2>
            ...
            <div class="container text-center pb-4">
                <div class="row border border-dark">
                    <h2 class="col-sm-11">7. I want to change my username. Do I have to start a new account?</h2>
