        ...
        <div class="row align-items-center">
            <div class="d-flex flex-column col-1 ps-5">
                <button type="button" class="btn btn-link ps-0 ms-0">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chevron-up" viewBox="0 0 16 16" onclick="upVote({{$event->id}}, event, this)">
                        <path fill-rule="evenodd" d="M7.646 4.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1-.708.708L8 5.707l-5.646 5.647a.5.5 0 0 1-.708-.708l6-6z" />
                    </svg>
                </button>
                <p class="pt-3 ps-1 pe-0">{{ $event->votes }}</p>
                <button type="button" class="btn btn-link ps-0 ms-0">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chevron-down" viewBox="0 0 16 16" onclick="downVote({{$event->id}}, event, this)">
            ...
            <div class="col-8">
                ...
                <div class="d-flex flex-row justify-content-between align-items-end">
                    ...
                    <button type="button" class="btn btn-link pb-4" style="text-decoration: none;">
                        ...
                        <span>Created by {{$event->manager}}</span>
                    </button>
                    <button type="button" class="btn btn-link pb-4" style="text-decoration: none;">
