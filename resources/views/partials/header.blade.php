    ...
    <nav class="navbar navbar-expand-lg bg-light">
        <div class="container-fluid d-flex flex-row justify-content-around align-items-center">
            ...
            <div class="d-none d-md-flex align-items-baseline">
                @if (Auth::check())
                <a class="text-decoration-none" href="{{ url('/profile/' . Auth::user()->id) }}"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-person" viewBox="0 0 16 16">
                ...
                @else
                <a class="btn btn-dark me-3" style="--bs-btn-padding-y: .60rem; --bs-btn-padding-x: 2rem; --bs-btn-font-size: .90rem;" href="{{ url('/login') }}"> LOG IN</a>
                <a class="btn btn-secondary" style="--bs-btn-padding-y: .60rem; --bs-btn-padding-x: 2rem; --bs-btn-font-size: .90rem;" href="{{ url('/register') }}"> SIGN UP </a>
                @endif
            </div>
        </div>
    </nav>
