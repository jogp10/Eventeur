    ...
    <nav class="navbar navbar-expand-lg bg-light">
        <div class="container-fluid d-flex flex-row justify-content-around align-items-center">
            ...
            <div class="input-group d-none d-md-flex align-self-center w-50">
                <form class="column d-md-flex align-self-center form-inline" action="{{ url('/search') }}" style="width:80%">
            ...
            <div class="d-none d-md-flex align-items-baseline">
                @if (Auth::check())
                <a><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-bell me-2" viewBox="0 0 16 16">
