<div class="row border border-dark m-5 rounded" data-id="{{$invite->event->id}}">
    <div class="container">
        <div class="row align-items-center">
            <div class="d-flex flex-column col-1 ps-3 align-self-start">
                @include('partials.form', ['action' => 'up', 'id' => $invite->event->id, 'type' => 'invite->event'])
                <span class="d-flex justify-content-center">{{ $invite->event->votes->count() }}</span>
            ...
            <div class="col-8">
                ...
                <div class="d-flex flex-row justify-content-between align-items-end">
                    <button type="button" class="btn pb-4" style="text-decoration: none;">
                        ...
                        <span>{{ count($invite->event->comments) }} Comment</span>
                    </button>
                    <button type="button" class="btn pb-4" style="text-decoration: none;">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-person" viewBox="0 0 16 16">
                            <path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0zm4 8c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4zm-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664h10z" />
                        </svg>
                        <span>Posted by {{$invite->event->manager->account->name}}</span>
                    </button>
                    <button type="button" class="btn pb-4" style="text-decoration: none;">
                        ...
                        <span>{{$invite->event->start_date}}</span>
                    </button>
                </div>
            </div>
